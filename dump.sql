...
--
-- Name: employees; Type: TABLE; Schema: public; Owner: db
--
...
ALTER TABLE public.employees OWNER TO db;

--
-- Data for Name: employees; Type: TABLE DATA; Schema: public; Owner: db
--
